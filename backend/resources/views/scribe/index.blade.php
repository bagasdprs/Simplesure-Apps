...
<head>
    ...
    <title>SimpleSure API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-policies">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-policies">
                                <a href="#endpoints-POSTapi-policies">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-policies--id-">
                                <a href="#endpoints-GETapi-policies--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-claims">
                                <a href="#endpoints-GETapi-claims">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-claims">
                                <a href="#endpoints-POSTapi-claims">Store a newly created resource in storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<code class="language-json" style="max-height: 300px;">[
    {
        ...
        &quot;is_active&quot;: true,
        &quot;created_at&quot;: &quot;2026-02-10T15:00:49.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2026-02-10T15:00:49.000000Z&quot;
    },
    {
        &quot;id&quot;: 2,
...
<p>The ID of the product. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-policies">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-policies">Store a newly created resource in storage.</h2>
...
<span id="example-requests-POSTapi-policies">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-policies">
</span>
<span id="execution-results-POSTapi-policies" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-policies"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-policies"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-policies" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-policies">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-policies" data-method="POST"
      data-path="api/policies"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-policies', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-policies"
                    onclick="tryItOut('POSTapi-policies');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-policies"
                    onclick="cancelTryOut('POSTapi-policies');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-policies"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-policies"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-policies"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="product_id"                data-endpoint="POSTapi-policies"
               value="consequatur"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="period"                data-endpoint="POSTapi-policies"
               value="yearly"
               data-component="body">
    <br>
...
<ul style="list-style-type: square;"><li><code>monthly</code></li> <li><code>yearly</code></li></ul>
                    ...
                    <h2 id="endpoints-GETapi-policies--id-">Display the specified resource.</h2>
...
<span id="example-requests-GETapi-policies--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/policies/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/policies/consequatur"
);
...
<span id="example-responses-GETapi-policies--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-policies--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-policies--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-policies--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-policies--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-policies--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-policies--id-" data-method="GET"
      data-path="api/policies/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-policies--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-policies--id-"
                    onclick="tryItOut('GETapi-policies--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-policies--id-"
                    onclick="cancelTryOut('GETapi-policies--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-policies--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-policies--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-policies--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-policies--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the policy. Example: <code>consequatur</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-claims">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-claims">Store a newly created resource in storage.</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "policy_id=consequatur"\
    --form "claim_reason=consequatur"\
    --form "description=Dolores dolorum amet iste laborum eius est dolor."\
    --form "claim_amount=11613.31890586"\
    --form "incident_date=2026-02-11T02:31:33"\
    --form "evidence=@C:\Users\User\AppData\Local\Temp\php5512.tmp" </code></pre></div>
...
body.append('policy_id', 'consequatur');
body.append('claim_reason', 'consequatur');
body.append('description', 'Dolores dolorum amet iste laborum eius est dolor.');
body.append('claim_amount', '11613.31890586');
body.append('incident_date', '2026-02-11T02:31:33');
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="policy_id"                data-endpoint="POSTapi-claims"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the policies table. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>claim_reason</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="claim_reason"                data-endpoint="POSTapi-claims"
               value="consequatur"
               data-component="body">
    <br>
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>claim_amount</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="claim_amount"                data-endpoint="POSTapi-claims"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="incident_date"                data-endpoint="POSTapi-claims"
               value="2026-02-11T02:31:33"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-11T02:31:33</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="evidence"                data-endpoint="POSTapi-claims"
               value=""
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\User\AppData\Local\Temp\php5512.tmp</code></p>
        </div>
        </form>
